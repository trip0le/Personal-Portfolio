...
- About
- Projects
- Contact (Once a user fills the contact form, an email containing the form details will be sent to the portfolio owner - emailjs has been used to develop this feature).
